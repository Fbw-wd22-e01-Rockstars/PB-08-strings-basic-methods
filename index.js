...
console.log(anything.slice(-3)+ anything + anything.slice(-3) )
...
const profession = "Teacher";
 console.log(`My name is ${first_name}, I an ${age} year old and I am a ${profession}`) 
